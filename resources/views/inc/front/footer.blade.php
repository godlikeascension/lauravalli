...
<footer class="bg-charcoal-blue pb-4 sm-pb-50px">
    <div class="container">
        <div class="row mb-6">
            <div class="col-lg-3 col-md-4 sm-mb-30px">
                <a href="/"><img src="/images/logolauwhite.png" data-at2x="/images/logolauwhite.png" alt=""></a>
            </div>
            <div class="col-lg-5 offset-lg-4 col-md-6 offset-md-2 sm-mb-30px">
                <h3 class="text-white fw-500 alt-font mb-50px ls-minus-1px sm-mb-30px">{{ trad('footer', 'tagline', 'Diamo vita a qualcosa di unico insieme') }}</h3>
                <div class="row">
                    <div class="col-12">
                        <span class="alt-font fs-14 text-uppercase d-block text-white ls-1px lh-24">{{ trad('footer', 'email_label', 'Contattami per email') }}</span>
