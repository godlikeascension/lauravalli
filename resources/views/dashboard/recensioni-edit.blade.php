                                    ...
                                    <div class="tab-content mb-3">
                                        <div class="tab-pane fade show active" id="rec-tab-it" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="testo" rows="4" class="form-control" required>{{ old('testo', $recensione->testo) }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nome di chi lascia la recensione <span class="text-danger">*</span></label>
                                                <input type="text" name="nome" class="form-control" value="{{ old('nome', $recensione->nome) }}" required>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="rec-tab-en" role="tabpanel">
                                            <div class="mb-3">
                                                <label class="form-label">Review text (EN)</label>
                                                <textarea name="testo_en" rows="4" class="form-control">{{ old('testo_en', $recensione->testo_en) }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Reviewer name (EN)</label>
                                                <input type="text" name="nome_en" class="form-control" value="{{ old('nome_en', $recensione->nome_en) }}">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="rec-tab-es" role="tabpanel">
                                            <div class="mb-3">
                                                <label class="form-label">Texto de la reseña (ES)</label>
                                                <textarea name="testo_es" rows="4" class="form-control">{{ old('testo_es', $recensione->testo_es) }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nombre del autor (ES)</label>
                                                <input type="text" name="nome_es" class="form-control" value="{{ old('nome_es', $recensione->nome_es) }}">
                                            </div>
                                        </div>
                                    </div>
