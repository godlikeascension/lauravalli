                                    ...
                                    <div class="tab-content mb-3">
                                        <div class="tab-pane fade show active" id="rec-tab-it" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="testo" id="rec-testo" rows="4" class="form-control" required>{{ old('testo', $recensione->testo) }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="tab-pane fade" id="rec-tab-en" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="testo_en" id="rec-testo-en" rows="4" class="form-control">{{ old('testo_en', $recensione->testo_en) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="rec-tab-es" role="tabpanel">
                                            <div class="mb-3">
                                                <label class="form-label">Texto de la reseña (ES)</label>
                                                <textarea name="testo_es" id="rec-testo-es" rows="4" class="form-control">{{ old('testo_es', $recensione->testo_es) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
