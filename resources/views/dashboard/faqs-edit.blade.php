                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="header-title mb-0">Modifica FAQ #{{ $faq->id }}</h4>
                                    ...
                                    <div class="tab-content mb-3">
                                        <div class="tab-pane fade show active" id="faq-tab-it" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="domanda" class="form-control" value="{{ old('domanda', $faq->domanda) }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">Risposta</label>
                                                <textarea name="risposta_html" id="risposta_html" rows="8" class="form-control">{{ old('risposta_html', $faq->risposta_html) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="faq-tab-en" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="risposta_html_en" id="risposta_html_en" rows="8" class="form-control">{{ old('risposta_html_en', $faq->risposta_html_en) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="faq-tab-es" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="risposta_html_es" id="risposta_html_es" rows="8" class="form-control">{{ old('risposta_html_es', $faq->risposta_html_es) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
